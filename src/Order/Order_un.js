...
function resetTodoList() {
  ...
  return (
    ...
    <div id="nav">
      ...
      <Button variant="outline-success" className="ingre" name="comcombre" onClick={() => {addToCart(ingredients[1]["ingredient"][0]);setCount(count + parseInt(ingredients[1]["Prix_ingre"]["tomates"]))}}>Concombres</Button>
      <Button variant="outline-success" className="ingre" name="tomates" onClick={() => {addToCart(ingredients[1]["ingredient"][1]);setCount(count + parseInt(ingredients[1]["Prix_ingre"]["tomates"]))}}>tomates</Button>
      <Button variant="outline-success" className="ingre" name="maïs" onClick={() => {addToCart(ingredients[1]["ingredient"][2]);setCount(count + parseInt(ingredients[1]["Prix_ingre"]["tomates"]))}}>maïs</Button>
      <Button variant="outline-success" className="ingre" name="vinaigrette" onClick={() => {addToCart(ingredients[1]["ingredient"][3]);setCount(count + parseInt(ingredients[1]["Prix_ingre"]["tomates"]))}}>vinaigrette</Button>
      </div>
