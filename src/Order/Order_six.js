...
function Order_six() {
  const [count, setCount] = useState(ingredients[6].Prix_salade)
...
function resetTodoList() {
  ...
  return (
    ...
    <div id="nav">
      <div id="ingredients">    
        <div >
          <h2>{ingredients && ingredients[6].title}</h2>
          <img src={ingredients && ingredients[6].photo} alt="Salade" className="pictures" />
        </div>
      </div>
      <div id="Order">
      <Button variant="outline-success" className="ingre" name="comcombre" onClick={() => setCount(count + ingredients[6].Prix_salade)}> + 1</Button>
      <Button variant="outline-success" className="ingre" name="comcombre" onClick={() => setCount(count - ingredients[6].Prix_salade)}> - 1</Button>
      ...
      <div id="invoice">
        ...
        <Button variant="outline-success" className="order" onClick={() => {resetTodoList();setCount(ingredients[6]["Prix_salade"])}}> Reset</Button>
