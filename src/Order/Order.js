    ...
    <div id="nav">
      <div id="ingredients">    
        <div >
          ...
          <img src={ingredients && ingredients[0].photo} alt="Salade" className="pictures" />
        </div>
      </div>
      <div id="Order">
      ...
      <div id="invoice">
        ...
        <Button variant="outline-success" className="order" onClick={() => {resetTodoList();setCount(ingredients[0]["Prix_salade"])}} > Reset</Button>
